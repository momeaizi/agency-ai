  ...
  return (
    ...
    >
      <Title
        ...
        description="Browse our portfolio of innovative digital projects that showcase creativity, performance, and results."
      />
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
        {
          workData.map((work, index) => (
            <div key={index} className="hover:scale-102 duration-500 transition-all cursor-pointer">
              ...
              <p className="text-sm opcaity-60 w-5/6">{ work.description }</p>
            </div>
          ))
        }
      </div>
